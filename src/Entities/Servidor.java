...
public class Servidor extends Thread {
	...
	// Inicia o servidor, recebe uma conexão na porta, e inicia num novo thread para
	// cada cliente
...
//recebe o nome do cliente e adiciona na lista de clientes conectados, assim é possível mandar msg a todos.
	public void run() {
		try {
			//recebe o que alguem esta mandando
			BufferedReader entrada = new BufferedReader(new InputStreamReader(this.conexao.getInputStream()));
			//envia a mensagem deste cliente para os outros
	...
	// Recebe todos os clientes na lista e envia a todos os outros exceto a quem
	// está enviando a msg
